...
Let C be the highest magnitude coefficient of the polynomial in B. We know that B is bounded above and below by $\pm (C n^{m})$. \\ 

It follows that $\displaystyle \frac{b^{m+1}}{n^{m+1}} B$ is bounded above and below by $\displaystyle \pm \frac{b^{m+1}}{n^{m+1}} Cn^{m}$ \\
